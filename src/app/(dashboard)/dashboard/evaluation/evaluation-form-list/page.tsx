...
// import { useAgreementFormsQuery, useCreateAgreementFormMutation, useDeleteAgreementFormMutation, useUpdateAgreementFormMutation } from "@/redux/feature/evaluationSlice";
...
//     { id: 1, name: "Form 1", file: null, fileSize: "PDF . 12MB", status: "pending" },
//     { id: 2, name: "Form 2", file: null, fileSize: "Pdf file only", status: "pending" },
//     { id: 3, name: "Form 3", file: null, fileSize: "PDF . 12MB", status: "pending" },
//     { id: 4, name: "Form 4", file: null, fileSize: "PDF . 12MB", status: "pending" },
//     { id: 5, name: "Form 5", file: null, fileSize: "Pdf file only", status: "pending" },
//     { id: 6, name: "Form 6", file: null, fileSize: "PDF . 12MB", status: "pending" },
// ];
...
//         mode: "edit",
//     });
//     const [addFormModal, setAddFormModal] = useState<AddFormModalState>({
//         isOpen: false,
//         name: "",
//         file: null,
//         dragOver: false,
...
//     const { data } = useAgreementFormsQuery();
...
//     const handleFileSelect = (formId: number, file: File) => {
...
//     const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>, formId: number) => {
//         if (e.target.files?.[0]) {
//             handleFileSelect(formId, e.target.files[0]);
//         }
//     };

//     const handleDragOver = (e: React.DragEvent, formId: number) => {
//         e.preventDefault();
//         setDragOver(formId);
//     };
...
//     const handleDrop = (e: React.DragEvent, formId: number) => {
//         e.preventDefault();
//         setDragOver(null);
//         if (e.dataTransfer.files?.[0]) {
//             handleFileSelect(formId, e.dataTransfer.files[0]);
//         }
//     };

//     const handleViewFile = (form: FormData) => {
//         if (form.file) {
...
//     const handleRemoveFile = (formId: number) => {
//         setForms(
//             forms.map((form) =>
//                 form.id === formId
//                     ? { ...form, file: null, status: "pending" as const, fileSize: "PDF . 12MB" }
//                     : form
//             )
//         );
//     };
...
//     const handleAddFormModalNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
//         setAddFormModal({ ...addFormModal, name: e.target.value });
//     };

//     const handleAddFormModalFileSelect = (file: File) => {
//         if (file.type === "application/pdf") {
//             setAddFormModal({ ...addFormModal, file });
//         } else {
//             alert("Please upload a PDF file only");
//         }
//     };

//     const handleAddFormModalDragOver = (e: React.DragEvent) => {
//         e.preventDefault();
//         setAddFormModal({ ...addFormModal, dragOver: true });
//     };

//     const handleAddFormModalDragLeave = () => {
//         setAddFormModal({ ...addFormModal, dragOver: false });
//     };

//     const handleAddFormModalDrop = (e: React.DragEvent) => {
//         e.preventDefault();
//         setAddFormModal({ ...addFormModal, dragOver: false });
//         if (e.dataTransfer.files?.[0]) {
//             handleAddFormModalFileSelect(e.dataTransfer.files[0]);
//         }
//     };

//     const handleAddFormModalSubmit = () => {
//         if (!addFormModal.name.trim()) {
//             alert("Please enter a form name");
//             return;
//         }

//         if (!addFormModal.file) {
//             alert("Please upload a file");
//             return;
//         }

//         const newId = Math.max(...forms.map((f) => f.id), 0) + 1;
//         const fileSizeMB = (addFormModal.file.size / (1024 * 1024)).toFixed(2);
//         const newForm: FormData = {
//             id: newId,
//             name: addFormModal.name,
//             file: addFormModal.file,
//             fileSize: `PDF . ${fileSizeMB}MB`,
//             status: "uploaded",
//         };
...
//     const handleEditFormName = (formId: number, currentName: string) => {
//         setEditingFormId(formId);
//         setEditingName(currentName);
//     };

//     const handleSaveFormName = (formId: number) => {
//         if (!editingName.trim()) {
//             alert("Please enter a form name");
//             return;
//         }
...
//         setForms(
//             forms.map((form) =>
//                 form.id === formId ? { ...form, name: editingName } : form
//             )
//         );
...
//     const handleOpenModal = (form: FormData) => {
//         setModal({
//             isOpen: true,
//             formId: form.id,
//             formName: form.name,
...
//         if (modal.formId) {
//             handleFileSelect(modal.formId, file);
//             handleCloseModal();
//         }
//     };
...
//         const uploadedForms = forms.filter((f) => f.file);
//         if (uploadedForms.length === 0) {
//             alert("Please upload at least one form");
//             return;
//         }

//         const formData = new FormData();
//         uploadedForms.forEach((form) => {
//             if (form.file) {
//                 formData.append(`form_${form.id}`, form.file);
//                 formData.append(`form_name_${form.id}`, form.name);
//             }
//         });

//         try {
//             const response = await fetch("/api/evaluation/upload-forms", {
//                 method: "POST",
//                 body: formData,
//             });
...
//             } else {
//                 alert("Failed to upload forms");
//             }
//         } catch (error) {
//             console.error("Upload error:", error);
//             alert("Error uploading forms");
//         }
//     };
...
//                 <h1 className="text-[#1F1F1F] text-2xl sm:text-[32px] font-bold italic">Total {forms.length} Forms</h1>
//             </div>
...
//                     className="bg-[#B21F1F] hover:bg-[#8B1818] text-white font-bold px-6 py-3 text-sm tracking-widest uppercase whitespace-nowrap transition-all flex items-center justify-center gap-2"
//                 >
//                     <Plus size={18} />
//                     Add New Form
//                 </button>
...
//                     <div
//                         key={form.id}
//                         className="bg-[#F9FAFB] border border-[#EAECF0] rounded-lg p-6 hover:shadow-md transition-shadow relative cursor-pointer hover:border-[#F65353]"
//                     >
//                         {/* Delete Button */}
//                         <button
//                             onClick={() => handleDeleteForm(form.id)}
//                             className="absolute top-4 right-4 text-[#F65353] hover:text-[#E63946] transition-colors"
//                             title="Delete form"
//                         >
//                             <X size={20} />
//                         </button>
...
//                                     className="flex-1 px-3 py-2 border border-[#D0D5DD] rounded-md text-[#1F1F1F] focus:outline-none focus:ring-2 focus:ring-[#F65353]"
//                                     autoFocus
//                                 />
//                                 <button
//                                     onClick={() => handleSaveFormName(form.id)}
//                                     className="bg-[#038862] hover:bg-[#026C4F] text-white px-3 py-2 text-sm font-bold transition-colors"
//                                 >
//                                     Save
//                                 </button>
//                             </div>
...
//                                 <h3 className="text-[#1F1F1F] text-lg font-bold mb-1">{form.name}</h3>
//                                 <button
//                                     onClick={() => handleEditFormName(form.id, form.name)}
//                                     className="text-[#F65353] hover:text-[#E63946] text-xs font-medium transition-colors"
//                                 >
//                                     Edit Name
//                                 </button>
//                             </div>
...
//                         {/* File Info */}
//                         <p className="text-[#696969] text-sm font-medium mb-4">{form.fileSize}</p>

//                         {/* Upload Area or File Display */}
//                         {form.file ? (
//                             <div className="bg-white border-2 border-[#038862] rounded-md p-4 mb-4">
//                                 <div className="flex items-center justify-between">
//                                     <div className="flex items-center gap-2 flex-1">
//                                         <div className="w-8 h-8 bg-[#F65353] rounded flex items-center justify-center text-white text-xs font-bold shrink-0">
//                                             PDF
//                                         </div>
//                                         <div className="text-sm min-w-0">
//                                             <p className="text-[#1F1F1F] font-medium truncate">{form.file.name}</p>
//                                             <p className="text-[#696969] text-xs">{form.fileSize}</p>
//                                         </div>
//                                     </div>
//                                     <button
//                                         onClick={() => handleRemoveFile(form.id)}
//                                         className="text-[#F65353] hover:text-[#E63946] transition-colors shrink-0 ml-2"
//                                     >
//                                         <X size={18} />
//                                     </button>
//                                 </div>
...
//                         ) : (
//                             <div
//                                 onDragOver={(e) => handleDragOver(e, form.id)}
//                                 onDragLeave={handleDragLeave}
//                                 onDrop={(e) => handleDrop(e, form.id)}
//                                 className={`border-2 border-dashed rounded-md p-6 text-center cursor-pointer transition-colors mb-4 ${dragOver === form.id
//                                     ? "border-[#F65353] bg-[#FFF7F7]"
...
//                                 />
//                                 <label htmlFor={`file-input-${form.id}`} className="cursor-pointer block">
//                                     <Upload size={24} className="mx-auto mb-2 text-[#667085]" />
//                                     <p className="text-[#1F1F1F] text-sm font-medium">Drag and drop your PDF</p>
//                                     <p className="text-[#696969] text-xs mt-1">or click to browse</p>
//                                 </label>
//                             </div>
//                         )}

//                         <div>
//                             <button className="border w-full py-2" >View</button>
//                         </div>
...
//                     <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 animate-in fade-in zoom-in duration-300">
//                         {/* Modal Header */}
//                         <div className="mb-6 flex items-center justify-between">
//                             <h2 className="text-[#1F1F1F] text-xl font-bold italic">Add New Form</h2>
//                             <button
//                                 onClick={handleCloseAddFormModal}
//                                 className="text-[#667085] hover:text-[#1F1F1F] transition-colors"
//                             >
//                                 <X size={24} />
//                             </button>
//                         </div>
...
//                         {/* Form Name Input */}
//                         <div className="mb-6">
//                             <label className="block text-[#1F1F1F] font-semibold text-sm mb-2">Form Name</label>
//                             <input
//                                 type="text"
//                                 value={addFormModal.name}
//                                 onChange={handleAddFormModalNameChange}
//                                 placeholder="Enter form name (e.g., Form 7, Certificate)"
//                                 className="w-full px-4 py-3 border border-[#D0D5DD] rounded-md text-[#1F1F1F] placeholder-[#696969] focus:outline-none focus:ring-2 focus:ring-[#F65353]"
//                             />
//                         </div>
...
//                         <div className="mb-6">
//                             {addFormModal.file ? (
//                                 <div className="bg-white border-2 border-[#038862] rounded-md p-4">
//                                     <div className="flex items-center justify-between">
//                                         <div className="flex items-center gap-2 flex-1">
//                                             <div className="w-8 h-8 bg-[#F65353] rounded flex items-center justify-center text-white text-xs font-bold shrink-0">
//                                                 PDF
//                                             </div>
//                                             <div className="text-sm min-w-0">
//                                                 <p className="text-[#1F1F1F] font-medium truncate">{addFormModal.file.name}</p>
//                                                 <p className="text-[#696969] text-xs">
//                                                     {(addFormModal.file.size / (1024 * 1024)).toFixed(2)}MB
//                                                 </p>
//                                             </div>
//                                         </div>
//                                         <button
//                                             onClick={() => setAddFormModal({ ...addFormModal, file: null })}
//                                             className="text-[#F65353] hover:text-[#E63946] transition-colors"
//                                         >
//                                             <X size={18} />
//                                         </button>
//                                     </div>
...
//                             ) : (
//                                 <div
//                                     onDragOver={handleAddFormModalDragOver}
//                                     onDragLeave={handleAddFormModalDragLeave}
//                                     onDrop={handleAddFormModalDrop}
//                                     className={`border-2 border-dashed rounded-md p-6 text-center cursor-pointer transition-colors ${addFormModal.dragOver
//                                         ? "border-[#F65353] bg-[#FFF7F7]"
//                                         : "border-[#D0D5DD] bg-white hover:bg-[#F9FAFB]"
//                                         }`}
//                                 >
...
//                                         onChange={(e) => {
//                                             if (e.target.files?.[0]) {
//                                                 handleAddFormModalFileSelect(e.target.files[0]);
//                                             }
//                                         }}
//                                         className="hidden"
//                                         id="add-form-file-input"
//                                     />
//                                     <label htmlFor="add-form-file-input" className="cursor-pointer block">
//                                         <Upload size={24} className="mx-auto mb-2 text-[#667085]" />
//                                         <p className="text-[#1F1F1F] text-sm font-medium">Drag and drop your PDF</p>
//                                         <p className="text-[#696969] text-xs mt-1">or click to browse</p>
//                                     </label>
...
//                             <button
//                                 onClick={handleCloseAddFormModal}
//                                 className="flex-1 border border-[#D0D5DD] text-[#667085] hover:bg-[#F9FAFB] font-bold py-3 text-sm transition-colors"
//                             >
//                                 CANCEL
//                             </button>
//                             <button
//                                 onClick={handleAddFormModalSubmit}
//                                 className="flex-1 bg-[#B21F1F] hover:bg-[#8B1818] text-white font-bold py-3 text-sm transition-colors"
//                             >
//                                 ADD FORM
//                             </button>
//                         </div>
